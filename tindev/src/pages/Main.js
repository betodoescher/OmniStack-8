            ...
            <View style={styles.cardsContainer}>
                ...
                { matchDev  && (
                    ...
                    <View style={styles.matchContainer}>
                        <Image source={itsamatch} style={styles.imageMatch}/>
                        <Image style={styles.avatarMatch} source={{ uri:  matchDev.avatar }}/>
                        <Text style={styles.nameMatch}>{matchDev.name}</Text>
                        <Text style={styles.bioMatch} numberOfLines={3}>{matchDev.bio}</Text>

                        <TouchableOpacity style={styles.buttonMatch} onPress={() => setMatchDev(null)}>
